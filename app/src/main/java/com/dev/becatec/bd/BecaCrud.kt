   ...
   fun newBeca(item:Becas) {
    ...
    fun insertarBecas(){
        ...
        val values2 = ContentValues().apply {
            put(BecaContract.Companion.Entrada.COLUMN_INSTITUCION, "Santander")
            put(BecaContract.Companion.Entrada.COLUMN_NOMBRE_BECA, "Santander Scholarships Language | English to Boost your Career")
            put(BecaContract.Companion.Entrada.COLUMN_DESC, "Banco Santander y Universidad de Pensilvania ofrecen 1.000 becas a través de un programa en línea de conocimientos de inglés para aquellos que estén interesados en progresar en sus carreras profesionales en un contexto de mercado de trabajo global. ")
            put(BecaContract.Companion.Entrada.COLUMN_IMAGE,"https://www.mystipendium.de/sites/default/files/santander-scholarships-english-boost-career-2022.jpg")
            put(BecaContract.Companion.Entrada.COLUMN_URL, "https://app.becas-santander.com/es/program/santander-scholarships-language-english-to-boost-your-career?category=LANGUAGEstatus%3Dopen&track=search")
            put(BecaContract.Companion.Entrada.COLUMN_status,"Active")
        }
        val values3 = ContentValues().apply {
            put(BecaContract.Companion.Entrada.COLUMN_INSTITUCION, "Santander")
            put(BecaContract.Companion.Entrada.COLUMN_NOMBRE_BECA, "Becas Santander Idiomas | BECAS LINGUA COMPLUTENSE-CSIM")
            put(BecaContract.Companion.Entrada.COLUMN_DESC, "Cursos de idiomas certificados por la Universidad Complutense de Madrid, con el mejor profesorado y pensados para que aprender otro idioma te resulte fácil y divertido.")
            put(BecaContract.Companion.Entrada.COLUMN_IMAGE,"https://i0.wp.com/cursosgratisonline.co/wp-content/uploads/2019/11/becas-santander.jpg?w=620&ssl=1")
            put(BecaContract.Companion.Entrada.COLUMN_URL, "https://app.becas-santander.com/es/program/becaslingua-complutense-csim?category=LANGUAGEstatus%3Dopen&track=search")
            put(BecaContract.Companion.Entrada.COLUMN_status,"Active")
        }
        val values4 = ContentValues().apply {
            put(BecaContract.Companion.Entrada.COLUMN_INSTITUCION, "Santander")
            put(BecaContract.Companion.Entrada.COLUMN_NOMBRE_BECA, "Becas Bootcamp Accenture – Fundación Universia de formación tecnológica")
            put(BecaContract.Companion.Entrada.COLUMN_DESC,"ACCENTURE y FUNDACIÓN UNIVERSIA otorgan un máximo de 15 becas destinadas a la realización de un curso de JAVA en THE BRIDGE. Estas becas están dirigidas a personas con discapacidad igual o superior al 33% con interés en estudios relacionados con las TIC.")
            put(BecaContract.Companion.Entrada.COLUMN_IMAGE,"https://www.rrhhdigital.com/userfiles/santander_universia.jpg")
            put(BecaContract.Companion.Entrada.COLUMN_URL, "https://app.becas-santander.com/es/program/becas-bootcamp-accenture-fundacion-universia-de-formacion-tecnologica?category=TECHstatus%3Dopen&track=search")
            put(BecaContract.Companion.Entrada.COLUMN_status,"Active")
        }
